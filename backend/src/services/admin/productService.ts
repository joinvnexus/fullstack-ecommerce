...
export const updateProduct = async (id: string, updates: any, adminInfo: any) => {
...
export const deleteProduct = async (id: string, adminInfo: any) => {
...
export const bulkUpdateProducts = async (action: string, productIds: string[], data: any, adminInfo: any) => {
  let result;
  switch (action) {
    case 'delete':
