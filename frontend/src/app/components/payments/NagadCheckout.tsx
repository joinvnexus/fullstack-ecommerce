...
const NagadCheckout = ({ orderId, amount, onSuccess, onError }: NagadCheckoutProps) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      <div className="mb-6">
        <div className="p-4 bg-purple-50 border border-purple-200 rounded-lg mb-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-purple-800 mb-1">Payment Instructions</h4>
              <ul className="text-sm text-purple-700 space-y-1">
                <li>1. You will be redirected to Nagad</li>
                <li>2. Enter your Nagad PIN to complete payment</li>
      ...
      >
        {isProcessing ? 'Redirecting...' : 'Pay with Nagad'}
      </button>

      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="text-center">
          <div className="inline-block bg-gray-100 px-4 py-2 rounded-lg">
            <div className="text-sm text-gray-600">Need Nagad help?</div>
            <div className="font-medium">16167</div>
          </div>
        </div>
      </div>
    </div>
